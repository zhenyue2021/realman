...
import org.jeecg.RealmanSystemApplication;
 ...
 * @Author: lsq
 */
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, classes = RealmanSystemApplication.class)
