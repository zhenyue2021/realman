...
- [~] OTA 平台详细设计（[草案已产出](./2026-07-09-ota-platform-detailed-design.md)，架构/接口/集成契约已可落地；状态机完整迁移矩阵、错误码完整枚举、17 项系统设置字段表因本次分析无法重新访问 PRD 原文，仍是开放问题，转正前需回源 PRD 核对，见该文档第十节）
