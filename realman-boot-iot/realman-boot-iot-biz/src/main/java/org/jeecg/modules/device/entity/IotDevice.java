...
public class IotDevice implements Serializable {
    ...
    /** 1-网关 2-传感器 3-控制器 */
    @TableField("device_type")   private Integer deviceType;
    @TableField("product_id")    private String productId;
    @TableField("device_model")  private String deviceModel;
    @TableField("serial_number") private String serialNumber;
    ...
    @TableField("device_secret") private String deviceSecret;
    @TableField("secret_create_time") private LocalDateTime secretCreateTime;
    @TableField("description")   private String description;
    @TableField("last_online_time")  private LocalDateTime lastOnlineTime;
    @TableField("last_offline_time") private LocalDateTime lastOfflineTime;
