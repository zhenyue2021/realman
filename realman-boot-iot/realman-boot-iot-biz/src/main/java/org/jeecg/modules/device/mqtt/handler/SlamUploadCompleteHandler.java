...
public class SlamUploadCompleteHandler {
    ...
    public void handle(String deviceCode, String payload) throws Exception {
        ...
        MqttMessageModel.SlamUploadComplete req =
                objectMapper.readValue(decrypted, MqttMessageModel.SlamUploadComplete.class);
        slamService.handleUploadComplete(deviceCode, req);
        log.info("[SLAM] 上传完成已处理 deviceCode={}, mapId={}, code={}",
                deviceCode, req.getMapId(), req.getCode());
    }
}
