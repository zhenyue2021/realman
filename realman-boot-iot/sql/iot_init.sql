...
-- IoT 日志归档历史表（配套 iotLogArchiveJob）

CREATE TABLE `iot_device_command_record_history` (
...
CREATE TABLE `iot_device_operation_log_history` (
    `id` varchar(32) NOT NULL COMMENT '主键（与主表一致）',
    `device_id` varchar(32) DEFAULT NULL COMMENT '设备ID',
    `device_code` varchar(64) NOT NULL COMMENT '设备编号',
...
CREATE TABLE `iot_mq_message_log_history` (
